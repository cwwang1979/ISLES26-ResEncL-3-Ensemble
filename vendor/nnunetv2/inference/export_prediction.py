...
def export_prediction_from_logits(predicted_array_or_file: Union[np.ndarray, torch.Tensor], properties_dict: dict,
    ...
    segmentation_post = segmentation_final.copy()
    print("Post-processing prediction")
    instance_mask, num_features = ndimage.label(segmentation_post)
    if num_features > 1:
        print("///// Found multiple lesion predictions /////")
        segmentation_post[instance_mask != instance_mask[int(128 / 2), int(256 / 2), int(256 / 2)]] = 0
        segmentation_post[segmentation_post != 0] = 1
    segmentation_final = segmentation_post
