...
class nnUNetTrainer(object):
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        """
        # Compatibility for checkpoints trained with the newer architecture
        # plans schema. This vendored runtime predates that schema.
        if "architecture" in configuration_manager.configuration:
            ...
            return nnUNetTrainer_LadleResEncL.build_network_architecture(
                plans_manager,
                dataset_json,
